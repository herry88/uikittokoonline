...
class HerryCommerceRoutes {
  static const String splash = '/herrycommerce_splash';
  static const String onboarding = '/herrycommerce_onboarding';
  static const String signIn = '/herrycommerce_signIn';
  static const String forgotPassword = '/herrycommerce_forgotPassword';
  static const String forgotPasswordSuccess =
      '/herrycommerce_forgotPasswordSuccess';
  static const String signUp = '/herrycommerce_signUp';
  static const String home = '/herrycommerce_home';
  static const String browseProduct = '/herrycommerce_browseProduct';
  static const String browseCategory = '/herrycommerce_browseCategory';
  static const String notification = '/herrycommerce_notification';
  static const String offer = '/herrycommerce_offer';
  static const String feed = '/herrycommerce_feed';
  static const String activity = '/herrycommerce_activity';
  static const String search = '/herrycommerce_search';
  static const String product = '/herrycommerce_product';
  static const String review = '/herrycommerce_review';
  static const String photoListView = '/herrycommerce_photoListView';
  static const String checkout = '/herrycommerce_checkout';
  static const String addressAdd = '/herrycommerce_address_add';
  static const String addressEdit = '/herrycommerce_address_edit';
  static const String paymentMethod = '/herrycommerce_paymentMethod';
  static const String profileEdit = '/herrycommerce_profileEdit';
  static const String profileDetail = '/herrycommerce_profileDetail';
  static const String address = '/herrycommerce_address';
...
class Assets {
  ...
  static const String manUnderwear =
      'assets/icons/bellcommerce_manunderwear.png';
  ...
  static const String notification =
      'assets/icons/bellcommerce_notification.svg';
